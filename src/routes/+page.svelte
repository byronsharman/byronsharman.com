...
<div class="flex flex-col min-h-screen bg-neutral-50 dark:bg-neutral-800">
      ...
      <article class="max-w-[960px] mx-auto my-4 sm:my-8">
        <div class="w-full flex flex-col gap-std md:gap-18 sm:flex-row-reverse sm:justify-between sm:items-center">
          ...
          <div class="max-w-[500px]">
            ...
            <a href="/experience" class="block w-fit my-lg sm:mb-0 lg:mt-std border-b text-fg-primary dark:text-fg-primary-dark group">
              See my experience
  ...
  <div class="mx-std">
    <footer class="my-std">
      ...
      <div class="w-full max-w-(--content-width) mx-auto flex flex-row justify-between text-center text-fg-tertiary dark:text-fg-tertiary-dark text-xs">

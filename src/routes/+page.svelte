...
<footer class="flex flex-row justify-between mt-8 lg:mt-16 text-gray-600 text-xs">
  ...
  <p class="mx-4">Come here from one of my friends' sites? Use these buttons to navigate the webring.</p>

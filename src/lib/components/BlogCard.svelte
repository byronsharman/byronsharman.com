...
<a href={blog.url} class="col-span-1 row-span-1 block p-6 bg-white dark:bg-bg-secondary-dark rounded-lg border border-stone-200 hover:shadow-lg transition">
  <article class="card">
